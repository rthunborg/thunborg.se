...
export function TeaserCard({ heading, hook, href }: TeaserCardProps) {
  return (
    ...
    >
      ...
      <span className="mt-auto pt-2 text-sm font-medium text-[#F59E0B] transition-colors duration-200 ease-out group-hover:text-[#FBBF24] motion-reduce:transition-none">
        Read more &rarr;
      </span>
    </Link>
  );
